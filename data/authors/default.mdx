...
I have a <span className="about-hight">passion for hands-on exploration, paying attention to detail, and creating aesthetically pleasing designs</span>. I have strong skills in big data visualization and smart IoT solutions. My development expertise spans multiple platforms, including PC, responsive design, mobile Html5, and WeChat Mini Programs. I enjoy the challenge of making user interfaces work seamlessly across different devices.

I enjoy the flexibility of remote work and also value maintaining a <span className="about-hight">healthy work-life balance</span>. In my free time, I am a clay crafting enthusiast and literature explorer. I also enjoy watching TV shows like 'TBBT','Modern Family' and 'Friends'. As a fan of rock music, I appreciate bands like Bon Jovi and Wu Bai. To stay active, I play table tennis and go running.
